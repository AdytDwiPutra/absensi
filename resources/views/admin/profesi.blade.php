            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" class="form-submit" method="POST" action="{{ route('profesi.tambah') }}" novalidate>
                                @csrf
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Profesi yang tersedia</li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <tbody>
                                @foreach ($data as $a)
                                    <tr>
                                        ...
                                        <td>{{ $a->profesi }}</td>
                                        <td align="center">
                                            <a href="{{ url('profesi/delete/'.$a->id) }}" data-type="confirm" class="btn btn-danger js-sweetalert" title="Delete"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
